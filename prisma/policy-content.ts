...
export const PRIVACY_POLICY_MD = `사단법인 한국게임정책학회(이하 '본 학회'라 한다)는 「인터랙티브미디어저널」 투고 · 심사 시스템(이하 '본 시스템'이라 한다)을 운영함에 있어 「개인정보 보호법」 등 관계 법령을 준수하며, 이용자의 개인정보 보호에 최선을 다하고 있습니다. 본 학회는 개인정보처리방침을 통하여 이용자가 제공하는 개인정보가 어떠한 목적과 방식으로 이용되고 있으며, 개인정보 보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
